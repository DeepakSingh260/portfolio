...
import { SiAntdesign, SiFigma, SiFlask, SiMaterialdesign, SiSelenium, SiTableau, SiTensorflow } from "react-icons/si";
import {
  TbBrandFramerMotion,
  TbBrandJavascript,
  TbBrandNextjs,
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <div className="hover:cursor-pointer">
                <BgSpringAnim>
                  <Tooltip
                    placement="bottom"
                    title={() => <div className="font-sans">Selenium</div>}
                  >
              ...
              <div className="hover:cursor-pointer">
                <BgSpringAnim>
                  <Tooltip
                    placement="bottom"
                    title={() => <div className="font-sans">Flask</div>}
                  >
              ...
              <div className="hover:cursor-pointer">
                <BgSpringAnim>
                  <Tooltip
                    placement="bottom"
                    title={() => <div className="font-sans">Tableau</div>}
                  >
              ...
              <div className="hover:cursor-pointer">
                <BgSpringAnim>
                  <Tooltip
                    placement="bottom"
                    title={() => <div className="font-sans">Tensorflow</div>}
                  >
